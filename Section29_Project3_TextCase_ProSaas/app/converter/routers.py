...
@routers.post("/generate-api-key", response_model=APIKeyOut)
...
@routers.get("/me/api-key", response_model=APIKeyOut)
...
@routers.get("/me/credits", response_model=CreditBalance)
...
@routers.get("/credit-requests", response_model=List[CreditRequestOut])
...
@routers.post("/buy/credits", response_model=CreditRequestOut)
...
@routers.post("/approve/credit/{request_id}", response_model=CreditRequestOut)
...
@routers.post("/convert", response_model=ConvertResponse)
